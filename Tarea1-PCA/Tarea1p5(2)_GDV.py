# -*- coding: utf-8 -*-
"""
Created on Thu Oct 20 16:29:08 2022
...
"PCA y proyecciones tridimensionales"
...
"Punto de vista plot en 3d"
ax.view_init(20, 70) 
"20,70"
fig

ax.set_title('PCA tridimensional', fontsize = 20)
...
"Guardar foto del plot"
plt.savefig('bbdd_3d(7)', dpi='figure', format=None, metadata=None,
...
b = pd.concat([b, pd.DataFrame(pca.components_[2,:])], axis = 1)
b.columns = ['Variable','PC1','PC2','PC3']
print(b)
